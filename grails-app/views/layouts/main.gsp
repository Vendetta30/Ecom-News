            ...
            <div class="container-fluid">
                ...
                <nav id="mainmenu" class="navbar-left collapse navbar-collapse">
                    <a class="secondary-logo" href="index.html">
                        <asset:image class="img-responsive" src="logo.png" alt=""/>
                    </a>
                    <ul class="nav navbar-nav">
                        <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="index-boxed.html">Home Page <span class="badge">Boxed Layout</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="news-details-boxed.html">News Details Image <span
                                        class="badge">Boxed Layout</span></a></li>
                                <li><a href="news-details2-boxed.html">News Details Video <span
                                        class="badge">Boxed Layout</span></a></li>
                                <li><a href="listing-boxed.html">News Listing Page <span
                                        class="badge">Boxed Layout</span></a></li>
                                <li><a href="404-boxed.html">404 Error Page <span class="badge">Boxed Layout</span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown mega-dropdown"><a href="javascript:void(0);" class="dropdown-toggle"
                                                              data-toggle="dropdown">Mega Menu <span
                                    class="caret"></span></a>
                                                ...
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <a href="news-details.html">
                                                            <asset:image class="img-responsive" src="post/2.jpg"
                                                                         alt=""/>
                                                        </a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="entry-meta">
                                                        <ul class="list-inline">
                                                            <li class="publish-date"><a href="#"><i
                                                                    class="fa fa-clock-o"></i> Jan 5, 2016</a></li>
                                                            <li class="views"><a href="#"><i class="fa fa-eye"></i>21k
                                                            </a></li>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <a href="news-details.html">
                                                            <asset:image class="img-responsive" src="post/3.jpg"
                                                                         alt=""/>
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <a href="news-details.html">
                                                            <asset:image class="img-responsive" src="post/4.jpg"
                                                                         alt=""/>
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="post medium-post">
                                                <div class="entry-header">
                                                    <div class="entry-thumbnail">
                                                        <a href="news-details.html">
                                                            <asset:image class="img-responsive" src="post/5.jpg"
                                                                         alt=""/>
                                                        </a>
                                                    </div>
                                                </div>
                    ...
                    <div class="left-sidebar">
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html">
                                        <asset:image class="img-responsive" src="post/1.jpg" alt=""/>
                                </div>
                            </div>
                            ...
                            <div class="post-content">
                                <div class="entry-meta">
                                    <ul class="list-inline">
                                        <li class="publish-date"><a href="#"><i class="fa fa-clock-o"></i> Jan 5, 2016
                                        </a></li>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html"><asset:image class="img-responsive" src="post/2.jpg"
                                                                             alt=""/></a>
                                </div>
                            </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html">
                                        <asset:image class="img-responsive" src="post/4.jpg" alt=""/>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html">
                                        <asset:image class="img-responsive" src="post/3.jpg" alt=""/>
                                    </a>
                                </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html"><asset:image class="img-responsive" src="post/5.jpg"
                                                                             alt=""/></a>
                                </div>
                            </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html">
                                        <asset:image class="img-responsive" src="post/6.jpg" alt=""/>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html">
                                        <asset:image class="img-responsive" src="post/9.jpg" alt=""/>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html"><asset:image class="img-responsive" src="post/8.jpg"
                                                                             alt=""/></a>
                                </div>
                            </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html"><asset:image class="img-responsive" src="post/10.jpg"
                                                                             alt=""/></a>
                                </div>
                            </div>
                        ...
                        <div class="post medium-post">
                            <div class="entry-header">
                                <div class="entry-thumbnail">
                                    <a href="news-details.html"><asset:image class="img-responsive" src="post/11.jpg"
                                                                             alt=""/></a>
                                </div>
                            </div>
                    ...
                    <div id="site-content" class="site-content">
                        ...
                        <div class="middle-content">
                            <div id="top-news" class="section top-news">
                                <div class="post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <a href="news-details.html">
                                                <asset:image class="img-responsive" src="post/w2.jpg" alt=""/>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post-content">
                                        <div class="entry-meta">
                                            <ul class="list-inline">
                                                <li class="publish-date"><a href="#"><i
                                                        class="fa fa-clock-o"></i> Jan 25, 2016</a></li>
                                                <li class="views"><a href="#"><i class="fa fa-eye"></i>21k</a></li>
                                                <li class="loves"><a href="#"><i class="fa fa-heart-o"></i>372</a></li>
                                                <li class="comments"><i class="fa fa-comment-o"></i><a href="#">267</a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <a href="news-details.html">
                                                <asset:image class="img-responsive" src="post/w1.jpg" alt=""/>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="post">
                                    <div class="entry-header">
                                        <div class="entry-thumbnail">
                                            <a href="news-details.html"><asset:image class="img-responsive"
                                                                                     src="post/w3.jpg" alt=""/>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="health-feature">
                                    <div class="post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <a href="news-details.html">
                                                    <asset:image class="img-responsive" src="post/politics/4.jpg"
                                                                 alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="entry-meta">
                                                <ul class="list-inline">
                                                    <li class="publish-date"><a href="#"><i
                                                            class="fa fa-clock-o"></i> Jan 25, 2016</a></li>
                                                    <li class="views"><a href="#"><i class="fa fa-eye"></i>21k</a></li>
                                                    <li class="loves"><a href="#"><i class="fa fa-heart-o"></i>372</a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <a href="news-details.html">
                                                    <asset:image class="img-responsive" src="post/politics/1.jpg"
                                                                 alt=""/>
                                    ...
                                    <div class="post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <a href="news-details.html">
                                                    <asset:image class="img-responsive" src="post/politics/3.jpg"
                                                                 alt=""/>
                            ...
                            <div class="add inner-add">
                                <a href="#">
                                    <asset:image class="img-responsive" src="post/add/add4.jpg"
                                                 alt=""/>
                            </div><!--/.section-->
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <div class="post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <a href="news-details.html">
                                                        <asset:image class="img-responsive" src="post/t1.jpg" alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="post-content">
                                                <div class="entry-meta">
                                                    <ul class="list-inline">
                                                        ...
                                                        <li class="loves"><a href="#"><i class="fa fa-heart-o"></i>372
                                                        </a></li>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="post small-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <a href="news-details.html">
                                                        <asset:image class="img-responsive" src="post/t2.jpg" alt=""/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <a href="news-details.html">
                                                        <asset:image class="img-responsive" src="post/lifestyle/1.jpg"
                                                                     alt=""/>
                                        ...
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <a href="news-details.html">
                                                        <asset:image class="img-responsive" src="post/lifestyle/2.jpg"
                                                                     alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <a href="news-details.html">
                                                        <asset:image class="img-responsive" src="post/lifestyle/3.jpg"
                                                                     alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="post medium-post">
                                            <div class="entry-header">
                                                <div class="entry-thumbnail">
                                                    <a href="news-details.html">
                                                        <asset:image class="img-responsive" src="post/lifestyle/4.jpg"
                                                                     alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div id="photo-gallery" class="carousel slide carousel-fade" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <a href="#">
                                                <asset:image class="img-responsive" src="gallery/1.jpg"
                                                             alt=""/>

                                            </a>

                                            <h2><a href="#">No one can agree on how a dog is supposed to wear human pants</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#">
                                                <asset:image class="img-responsive" src="gallery/2.jpg"
                                                             alt=""/>
                                            </a>

                                            <h2><a href="#">500-pound elephant seal causes traffic jam while repeatedly</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#"><asset:image class="img-responsive" src="gallery/3.jpg"
                                                                     alt=""/>
                                            </a>

                                            <h2><a href="#">I rode a Metroboard electric skateboard 30 miles around Manhattan</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#"><asset:image class="img-responsive" src="gallery/4.jpg"
                                                                     alt=""/>
                                            </a>

                                            <h2><a href="#">The super creepy side of the Internet of Things and smart homes</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#"><asset:image class="img-responsive" src="gallery/5.jpg"
                                                                     alt=""/>
                                            </a>

                                            <h2><a href="#">Mirum est notare quam littera gothica, quam nunc putamus parum claram</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#"><asset:image class="img-responsive" src="gallery/6.jpg"
                                                                     alt=""/>
                                            </a>

                                            <h2><a href="#">Someone has calculated the total cost of saving Matt Damon</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#"><asset:image class="img-responsive" src="gallery/7.jpg"
                                                                     alt=""/>
                                            </a>

                                            <h2><a href="#">Wet wedding: Yorkshire couple dons wellies to tie the knot in flooded town</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#"><asset:image class="img-responsive" src="gallery/8.jpg"
                                                                     alt=""/>

                                            </a>

                                            <h2><a href="#">This dog is so stoked for his Christmas present he can hardly stand it</a>
                                            </h2>
                                        </div>

                                        <div class="item">
                                            <a href="#"><asset:image class="img-responsive" src="gallery/9.jpg"
                                                                     alt=""/>
                                            </a>

                                            <h2><a href="#">The world's richest people lost $19 billion in 2016, but Jeff Bezos</a>
                                            </h2>
                                        </div>
                                    </div><!--/carousel-inner-->
                                    ...
                                    <ol class="gallery-indicators carousel-indicators">
                                        <li data-target="#photo-gallery" data-slide-to="0" class="active">
                                            <asset:image class="img-responsive" src="gallery/thumb1.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="1">
                                            <asset:image class="img-responsive" src="gallery/thumb2.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="2">
                                            <asset:image class="img-responsive" src="gallery/thumb3.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="3">
                                            <asset:image class="img-responsive" src="gallery/thumb4.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="4">
                                            <asset:image class="img-responsive" src="gallery/thumb5.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="5">
                                            <asset:image class="img-responsive" src="gallery/thumb6.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="6">
                                            <asset:image class="img-responsive" src="gallery/thumb7.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="7">
                                            <asset:image class="img-responsive" src="gallery/thumb8.png"
                                                         alt=""/>
                                        </li>
                                        <li data-target="#photo-gallery" data-slide-to="8">
                                            <asset:image class="img-responsive" src="gallery/thumb9.png"
                                                         alt=""/>
                                        </li>
                ...
                <div class="col-sm-3">
                    <div id="sitebar">
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <a href="news-details.html">
                                                    <asset:image class="img-responsive" src="post/rising/1.jpg"
                                                                 alt=""/>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <div class="post small-post">
                                        <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <a href="news-details.html">
                                                    <asset:image class="img-responsive" src="post/rising/2.jpg"
                                                                 alt=""/>
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="widget">
                            <div class="add">
                                <a href="#">
                                    <asset:image class="img-responsive" src="post/add/add5.jpg"
                                                 alt=""/>
                            </div>
                        </div>
